...
class Channeltype extends Base
{
    ...
    // // 检测开启免登录条件
    // public function check_open_condition()
    // {
    //     if (IS_AJAX_POST) {
    //         $id = input('id/d', 0);
    //         // 商城中心开关
    ...
    //         // 会员中心开关
    //         $webUsersSwitch = tpCache('web.web_users_switch');
    //         // 开启会员中心、商城中心、支付功能则表示满足开启条件
    //         if (!empty($shopOpen) && !empty($webUsersSwitch)) {
    //             $this->success('检测通过');
    //         } else {
    //             if (2 === intval($id)) {
    //                 $return = 0;
    //                 $result = '请先开启：';
    //                 if (empty($webUsersSwitch)) {
    //                     $return = 1;
    //                     $result .= '会员中心，';
    //                 }
    //                 if (empty($shopOpen)) {
    ...
    //                 }
    //                 $result .= '再开启免登录！';
    //                 !empty($return) && $this->error($result);
    //             } else {
    //                 if (empty($webUsersSwitch)) $this->error('请先开启：会员中心，再开启免登录！');
    //             }
    //         }
    //     }
    // }
