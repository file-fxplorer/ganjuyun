...
class Form extends Base
{
    ...
    public function index()
    {
        ...
        $source = $param['source'] = empty($param['source']) ? '' : intval($param['source']);
                ...
                if(! empty($auth_role_info)){
                    ...
                    if(!empty($permission_arctype)){
                        ...
                        if (!empty($typeids_tmp1)) {
                            ...
                            $condition[] = Db::raw(" ((a.typeid IN ({$typeids_tmp2}) AND a.form_type = 0) OR (a.typeid IN ({$formids_tmp1}) AND a.form_type = 1)) ");
                        }
                    }
