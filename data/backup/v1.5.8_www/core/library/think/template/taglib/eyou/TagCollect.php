...
class TagCollect extends Base
{
    ...
    <script>window.tag_collection_list || document.write('<script src="{$this->root_dir}/public/static/common/js/tag_collection_list.js?t={$version}" type="text/javascript"><\/script>')</script>
