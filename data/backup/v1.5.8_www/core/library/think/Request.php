...
class Request
{
    ...
    public function rootDomain($domain = '')
    {
        ...
        if (!$root || !empty($domain)) {
            ...
            $domain_postfix_cn_array = ["com", "net", "org", "gov", "edu", "nm", "cn", "co", "hk", "sc", "ln", "sx", "hn", "zj", "jx", "yn", "gz", "ha", "sd", "xj", "cq", "me", "lt", "plc"];
            $array_domain = explode(".", $host);
            $array_num = count($array_domain) - 1;
            if (in_array($array_domain[$array_num], ['cn','tw','hk','nz','au','uk'])) {
