...
class FunctionLogic extends Model
{
    ...
    public function GetAllCommentInfo($users_id = null, $order_code = null)
    {
        ...
        // 订单主表数据查询
        $field = 'a.comment_id, a.order_id, a.order_code, a.product_id, a.total_score, a.add_time, b.product_name, b.product_price, b.litpic as product_img, b.num as product_num';
