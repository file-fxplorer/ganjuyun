<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"./application/admin/template/seo/seo.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/layout.htm";i:1679554578;s:81:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/theme_css.htm";i:1679554578;s:72:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/seo/bar.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/footer.htm";i:1679554578;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo url('Seo/handle'); ?>" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <?php if(is_array($seo_pseudo_list) || $seo_pseudo_list instanceof \think\Collection || $seo_pseudo_list instanceof \think\Paginator): $i = 0; $__LIST__ = $seo_pseudo_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <label class="curpoin <?php if(!empty($global['web_citysite_open']) && $key == 2): ?>grey<?php endif; ?>" <?php if(!empty($global['web_citysite_open']) && $key == 2): ?> title="你已开启城市分站，静态页面功能不可用" <?php endif; ?>>
                            <input type="radio" name="seo_pseudo" value="<?php echo $key; ?>" <?php if(isset($config['seo_pseudo']) && $config['seo_pseudo'] == $key): ?>checked="checked"<?php endif; if(((!empty($default_lang) && $default_lang != 'cn') || !empty($global['web_citysite_open'])) && $key == 2): ?>disabled class="grey"<?php endif; ?> /><?php echo $vo; ?>&nbsp;
                        </label>
            ...
            <dl class="row <?php if(empty($config['seo_pseudo']) || 1 != $config['seo_pseudo'] || (1 == $config['seo_pseudo'] && 1 == $config['seo_dynamic_format'])): ?>none<?php endif; ?>" id="dl_seo_dynamic_format">
                ...
                <dd class="opt">
                    <label class="curpoin"><input type="radio" name="seo_dynamic_format" value="1" <?php if(!isset($config['seo_dynamic_format']) OR $config['seo_dynamic_format'] == 1): ?>checked="checked"<?php endif; ?>>完全兼容（<a href="javascript:void(0);" onclick="view_exp('view_1_1');">查看例子</a><span id="view_1_1" class="none">：https://ganjuyun.com/index.php?m=home&amp;c=Lists&amp;a=index&amp;tid=1</span>）</label>&nbsp;
                    <?php if(isset($config['seo_dynamic_format']) AND $config['seo_dynamic_format'] == 2): ?>
                    <br/>
                    <label class="curpoin"><input type="radio" name="seo_dynamic_format" value="2" checked="checked">部分兼容&nbsp;<font color="red">[部分空间不支持]</font>（<a href="javascript:void(0);" onclick="view_exp('view_1_2');">查看例子</a><span id="view_1_2" class="none">：https://ganjuyun.com/home/Lists/index.html?tid=1</span>）</label>&nbsp;
                    <?php endif; ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row <?php if(isset($config['seo_pseudo']) && $config['seo_pseudo'] != 3): ?>none<?php endif; ?>" id="dl_seo_rewrite_format">
                ...
                <dd class="opt">
                    <label class="curpoin">
                        <input type="radio" name="seo_rewrite_format" <?php if(!isset($config['seo_rewrite_format']) OR $config['seo_rewrite_format'] == 1): ?> value="1" checked="checked" <?php else: ?> value="3" checked="checked" <?php endif; ?>>目录名称（<a href="javascript:void(0);" onclick="view_exp('view_3_1');">示例</a><span id="view_3_1" class="none">：https://ganjuyun.com/news/</span>）
                    </label>&nbsp;
                    <br/>
                    <label class="curpoin"><input type="radio" name="seo_rewrite_format" value="2" <?php if(isset($config['seo_rewrite_format']) AND $config['seo_rewrite_format'] == 2): ?>checked="checked"<?php endif; ?>>模型标识（<a href="javascript:void(0);" onclick="view_exp('view_3_2');">示例</a><span id="view_3_2" class="none">：https://ganjuyun.com/article/news.html</span>）</label>&nbsp;
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row <?php if(!isset($config['seo_pseudo']) OR $config['seo_pseudo'] != 3 OR $config['seo_rewrite_format'] == 2): ?>none<?php endif; ?>" id="dl_seo_rewrite_view_format">
                ...
                <dd class="opt">
                    <label class="curpoin"><input type="radio" name="seo_rewrite_view_format" value="1" <?php if((!isset($config['seo_rewrite_format']) OR $config['seo_rewrite_format'] == 1) OR (!isset($config['seo_rewrite_view_format']) OR $config['seo_rewrite_view_format'] == 1)): ?>checked="checked"<?php endif; ?>>父目录（<a href="javascript:void(0);" onclick="view_exp('view_3_3');">示例</a><span id="view_3_3" class="none">：https://ganjuyun.com/news/20.html</span>）</label>&nbsp;
                    <br/>
                    <label class="curpoin"><input type="radio" name="seo_rewrite_view_format" value="3" <?php if((isset($config['seo_rewrite_format']) AND $config['seo_rewrite_format'] == 3) OR $config['seo_rewrite_view_format'] == 3): ?>checked="checked"<?php endif; ?>>当前目录（<a href="javascript:void(0);" onclick="view_exp('view_3_4');">示例</a><span id="view_3_4" class="none">：https://ganjuyun.com/lol/20.html</span>）</label>&nbsp;
                    <br/>
                    <label class="curpoin"><input type="radio" name="seo_rewrite_view_format" value="4" <?php if((isset($config['seo_rewrite_format']) AND $config['seo_rewrite_format'] == 4) OR $config['seo_rewrite_view_format'] == 4): ?>checked="checked"<?php endif; ?>>父目录/当前目录/（<a href="javascript:void(0);" onclick="view_exp('view_3_5');">示例</a><span id="view_3_5" class="none">：https://ganjuyun.com/news/lol/20.html</span>）</label>&nbsp;
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
                    ...
                    success: function(res){
                        ...
                        if (res.code == 0) {
                            ...
                            if (res.data.msg != '') {
                                ...
                                var intro = '<style type="text/css">.layui-layer-content{text-align:left!important;}</style>';
                                intro += res.data.msg;
                ...
                layer.open({
                    ...
                    success: function(layero, index){
                        ...
                        if (content.indexOf("Congratulations on passing") == -1)
                        {
                            ...
                            layer.alert('不支持去除index.php，请<a href="javascript:void(0);" onclick="layer.closeAll();click_to_eyou_1575506523(\'https://www.eyoucms.com/plus/view.php?aid=7874&origin_eycms=1\',\'去掉URL中的index.php教程\');">点击查看教程</a>', {icon: 2, title:false});
                        }
                    }
                });
            }
