<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"./application/admin/template/article/edit.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/layout.htm";i:1679554578;s:81:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/theme_css.htm";i:1679554578;s:96:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/archives/get_field_addonextitem.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/footer.htm";i:1679554578;}*/ ?>
<!doctype html>
<html>
<head>
...
<?php if($editor['editor_select'] == '1'): ?>
    <script type="text/javascript" src="/public/plugins/Ueditor/ueditor.config.js?t=v1.6.2"></script>
    <script type="text/javascript" src="/public/plugins/Ueditor/ueditor.all.min.js?t=v1.6.2"></script>
    <script type="text/javascript" src="/public/plugins/Ueditor/lang/zh-cn/zh-cn.js?t=v1.6.2"></script>
<?php else: ?>
    <script type="text/javascript" src="/public/plugins/ckeditor/ckeditor.js?t=v1.6.2"></script>
<?php endif; ?>
            ...
            <dl class="row">
                ...
                <dd class="opt"> 
                    ...
                    <div id="stypeid_txt" class="pt5">
                        <?php if(is_array($stypeid_arr) || $stypeid_arr instanceof \think\Collection || $stypeid_arr instanceof \think\Paginator): $i = 0; $__LIST__ = $stypeid_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($key > '0'): ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php endif; ?><span><?php echo $vo['typename']; ?>(<?php echo $vo['id']; ?>)</span><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </dd>
            </dl>
            <?php endif; ?>
            ...
            <div class="<?php if(empty($channelRow['data']['is_article_pay'])): ?> none <?php endif; ?>">
                ...
                <div class="<?php if(empty($field['restric_type'])): ?> none <?php endif; ?>" id="div_free_html">
                    <dl class="row" id="dl_part_free">
                        <dt class="tit">
                            <label for="title"><em>*</em>付费预览</label>
                        </dt>
                        <dd class="opt">
                    ...
                    <dl class="row <?php if(empty($field['part_free']) or $field['part_free'] != '2'): ?> none <?php endif; ?>" id="dl_size">
                        ...
                        <dd class="opt">
                            <input type="text" name="size" value="<?php echo (isset($field['size']) && ($field['size'] !== '')?$field['size']:1); ?>" id="size" class="input-txt" maxlength="100" autocomplete="off" style="width: 100px !important;text-align: right;" onkeyup="this.value=this.value.replace(/[^\d\.]/g,'');" onpaste="this.value=this.value.replace(/[^\d\.]/g,'')">&nbsp;K
                            <span class="err"></span>
                            <p class="notic"></p>
                        </dd>
                    </dl>
