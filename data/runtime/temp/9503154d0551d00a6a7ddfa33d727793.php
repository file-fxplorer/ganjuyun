<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:44:"./application/admin/template/system/web2.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/layout.htm";i:1679554578;s:81:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/theme_css.htm";i:1679554578;s:75:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/system/bar.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/footer.htm";i:1679554578;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="web_tpl_theme">
                        ...
                        <?php if(is_array($tpl_theme_list) || $tpl_theme_list instanceof \think\Collection || $tpl_theme_list instanceof \think\Paginator): $i = 0; $__LIST__ = $tpl_theme_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(!in_array(($vo), explode(',',"default,plugins,weapp,pc,mobile,bom_backup"))): ?>
