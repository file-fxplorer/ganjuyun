<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"./application/admin/template/ad_position/add.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/layout.htm";i:1679554578;s:81:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/theme_css.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/footer.htm";i:1679554578;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    <form class="form-horizontal" id="post_form" action="<?php echo url('AdPosition/add'); ?>" method="post">
...
<script type="text/javascript">
    ...
    function checkForm(){
        ...
        $.ajax({
            type : 'post',
            url : "<?php echo url('AdPosition/add', ['_ajax'=>1]); ?>",
