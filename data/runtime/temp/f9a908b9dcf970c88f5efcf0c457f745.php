<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:48:"./application/admin/template/guestbook/index.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/layout.htm";i:1679554578;s:81:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/theme_css.htm";i:1679554578;s:76:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/page.htm";i:1679554578;s:78:"/www/wwwroot/weiguizhan/V2/V2HOME/application/admin/template/public/footer.htm";i:1679554578;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table style="width: 100%;">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <?php $__FOR_START_1213405538__=0;$__FOR_END_1213405538__=count($tab_list);for($i=$__FOR_START_1213405538__;$i < $__FOR_END_1213405538__;$i+=1){ if($i < 4): if($i == 0): ?>
                                    <td style="width: 100%">
                                        <div class="text-l10">
